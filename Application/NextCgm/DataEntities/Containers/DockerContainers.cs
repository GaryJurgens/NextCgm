...
namespace NextCgm.DataEntities.Containers
{
    public class DockerContainers
    {
        ...
        public string InstanceID { get; set; } // this is a unique identifier for this instance, and is used to create a unique container name and to identify the container in the system. This can be a combination of the base image name and a unique identifier, such as Nightscout-Mary-1234567890, where Nightscout-Mary is the base image name, and 1234567890 is a unique identifier for this instance.
        ...
        public DockerStatusEnums DockerStatus { get; set; }
